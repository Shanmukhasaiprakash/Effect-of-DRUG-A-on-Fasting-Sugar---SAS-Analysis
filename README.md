...
/* Step 1: Read Initial Study Dataset Contains patient demographics and hospital information*/
...
/* Step 2: Read Second Study Dataset Contains treatment group, site, and fasting sugar levels */
...
/* Step 4: Simple Random Sampling (SRS) Sample size = 1000 (no seed as per instructions) */
...
/* Step 6: Frequency Table Distribution of treatment groups across sites */
...
/* Step 8: Data Cleaning Remove missing test scores and invalid group values */
Data Analysis_Data;
set Sampled_Data;
if Group ne "n/a" and Test_Score ne .;
run;

/* Step 9: One-Way ANOVA Compare mean fasting sugar across treatment groups */
...
/* Step 10: GLM – One-Way Model with Variance Test Includes Levene’s test for homogeneity of variances */
...
/* Step 11: Two-Way ANOVA (GLM) Evaluate Group, Site, and Group*Site interaction effects */
Proc Glm Data=Analysis_Data;
Class Group Site;
...
/* Step 12: Visualization Histogram and density plot of fasting sugar by group */
